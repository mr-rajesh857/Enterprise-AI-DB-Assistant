                ...
                <td className="px-6 py-4 text-sm">
                  {log.sql_query ? (
                    <code 
                      ...
                      className={`text-xs bg-gray-100 px-2 py-1 rounded block max-w-xs cursor-pointer text-gray-900 ${
                        expandedQueries[log.id] ? 'whitespace-pre-wrap' : 'truncate'
                      }`}
                      title={expandedQueries[log.id] ? "Click to collapse" : "Click to expand"}
                    >
                      {log.sql_query}
                    </code>
                  ) : (
